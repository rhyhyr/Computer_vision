...
| 기법            | 목적       | 특징             |
| ------------- | -------- | -------------- |
| Sobel         | 경계 검출    | 빠르고 기본적인 에지 검출 |
| Canny + Hough | 정밀한 선 검출 | 노이즈 제거 + 직선 인식 |
| GrabCut       | 객체 분리    | 반자동 배경 제거      |
...
이 프로젝트는 컴퓨터 비전의 기초 개념을 이해하고,
실제 이미지 처리 파이프라인을 구성하는 데 도움을 줍니다.
